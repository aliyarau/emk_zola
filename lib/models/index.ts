// src/lib/models/index.ts (пример пути)
...
export const MODELS: ModelConfig[] = [
  {
    id: "gpt-4.1", // ← советую сделать id = фактическому имени модели
    name: "Auto",
    provider: "OpenAI",
    providerId: "openai",
    modelFamily: "o4",
    ...
    apiSdk: (apiKey?: string) => openAIModel("gpt-4.1", apiKey),
  } as ModelConfig,

  {
    id: "gpt-5-mini",
    name: "ChatEMK Instant",
    provider: "OpenAI",
    providerId: "openai",
    modelFamily: "o4",
    baseProviderId: "openai",
